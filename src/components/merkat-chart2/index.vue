<template lang="html">
  <div class="">
    <highcharts style="min-width: 310px; max-width: 1040px; height: 100px !important; max-height: 100px !important; margin: 0 auto; " class="graphCustom" :options="chartOptions"/>
  </div>
</template>
<script>
  ...
  data() {
    return {
      chartOptions: {
        ...
        xAxis: [{
            categories: ['11 oct.', '12 oct.', '13 oct.', '14 oct.', '15 oct.', '16 oct.',
        ...
        series: [{
          ...
          tooltip: {
            ...
            name: '',
            type: 'spline',
            data: [7.0, 6.9, 9.5, 14.5, 18.2, 21.5, 7.0, 6.9, 9.5, 14.5, 18.2, 21.5, 25.2, 26.5, 23.3, 18.3, 13.9, 9.6, 25.2, 26.5, 23.3, 18.3, 13.9, 9.6],
            tooltip: {
                valueSuffix: ''
            }
        }],
